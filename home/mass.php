...
<body>
	...
	<div class="container my-5">
		<div class="row mb-5">
			<img src="../img/banner/mass.jpg" alt="">
		</div>
	</div>
    ...
    <div class="container mb-5">
        ...
        <p>THE FOOD SUPPLEMENTS MARKET HAS CHANGED DRASTICALLY OVER THE LAST TWO DECADES.
...
Everybody seeks the magic bullet while ignoring the fact that nothing is more powerful than the consistent consumption of the proper amount of total calories, energizing carbs and muscle building protein.</p>
    </div>
