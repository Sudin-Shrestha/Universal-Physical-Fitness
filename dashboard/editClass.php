        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <strong>Edit Classes Description</strong> 
                </div>
                      ...
                      ';
                       ...
                       foreach($data as $class){
                        ...
                        <tbody>
                          ...
                          <td>'.$class['feature_1'].'</td>
                          <td>'.$class['feature_2'].'</td>
                          <td>'.$class['feature_3'].'</td>
                          <td>'.$class['feature_4'].'</td>
                          <td>'.$class['feature_5'].'</td>
                          <td><button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#editModal'.$class['id'].'">Edit</button></td>
                          <td><button type="button" class="btn btn-danger btn-sm"  data-toggle="modal" data-target="#deleteModal'.$class['id'].'">Delete</button></td>
                          </tr>
                            ...
                            <div class="modal-content">
                              ...
                              <form action="../controller/editClasses.php"  method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="packagePrice" name="packagePrice" placeholder="Enter price" value="'.$class["price"].'" required>
                                
                                    </div>
                                    <div class="form-group">
                                    <label for="packageDuartion">Duartion</label>
                                    <input type="text" class="form-control" id="packageDuration" name="packageDuration" placeholder="Enter Duartion" value="'.$class["duration"].'" required>
                                    </div>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              Do you want to delete <span class="text-danger"> '.$class['duration'].' </span> package.
                            </div>
                            <div class="modal-footer">
